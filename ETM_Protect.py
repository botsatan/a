...
#Cat_Bot
import NOXTIAN
from NOXTIAN.lib.curve.ttypes import *
...
#--------------------------------------------------------
                ...
                ki2.sendText(msg.to,"All invitations have been refused")

            elif msg.text in ["Cb3 Cancelall"]:
                gid = ki3.getGroupIdsInvited()
                for i in gid:
                    ki3.rejectGroupInvitation(i)
                ki3.sendText(msg.to,"All invitations have been refused")
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		try:
		    ...
		    ki2.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Mau Bot Protect?\nFollow ig : @rid1bdbx\nLalu dm ke dia")
		    ki3.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Mau Bot Protect?\nFollow ig : @rid1bdbx\nLalu dm ke dia")
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"Pasukan absen!!")
                ...
                ki2.sendText(msg.to,"Cb2 Hadiir  \(ˆ▿ˆ)/")
                ki3.sendText(msg.to,"Cb3 Hadiir  \(ˆ▿ˆ)/")
